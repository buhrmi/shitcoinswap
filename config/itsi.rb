...
workers ENV.fetch("ITSI_WORKERS", 1).to_i
...
worker_memory_limit 1024 * 1024 * 1024 * 4 # 4GB
...
intrusion_protection \
  banned_url_patterns: Itsi::Server::KnownPaths::ALL,
...
rate_limit \
  requests: 10,
  seconds: 10,
  key: { parameter: { header: { name: "X-Forwarded-For" } } }
